...
import CancelQuickButton from './CancelQuickButton'
            ...
            {!bookings || bookings.length === 0 ? (
              ...
              <div className="divide-y divide-border/60">
                {bookings.map((b: BookingData) => (
                  <div
                    key={b.id as string}
                    className="flex flex-col md:flex-row md:items-center justify-between p-6 hover:bg-muted/20 transition-colors"
                  >
                    <div className="flex-1 mb-4 md:mb-0">
                      ...
                      <div className="text-base font-bold text-foreground">
                        {formatDateTimeAR(b.start_datetime)} —{' '}
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      ...
                      <div className="flex w-full sm:w-auto gap-2 mt-2 sm:mt-0">
                        ...
                        {b.status !== 'confirmed' && b.status !== 'cancelled' && (
                          <Link
                            href={`/payments/start?bookingId=${b.id}&method=mercadopago`}
