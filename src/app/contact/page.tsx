    ...
    <div className="container py-12">
      <div className="mx-auto max-w-[800px]">
        ...
        <Card>
          ...
          <CardContent>
            {ok && (
              <div className="mb-4 p-3 text-sm text-green-600 bg-green-50 rounded-md">{ok}</div>
            )}
            {error && (
            ...
            <form className="grid gap-4" onSubmit={onSubmit}>
              ...
              <div className="space-y-2">
                ...
                <textarea id="message" className="min-h-[140px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" placeholder="Contanos cómo te podemos ayudar" value={message} onChange={(e) => setMessage(e.target.value)} required disabled={loading} />
              </div>
