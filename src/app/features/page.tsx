...
export const metadata = {
  title: 'Características | Courtify',
}
...
const features = [
  {
    ...
    points: ['Disponibilidad por fecha y horario', 'Reservas múltiples', 'Detección de conflictos', 'Listas de espera'],
  },
  {
    icon: CreditCard,
    title: 'Pagos',
  ...
  return (
    <div className="container py-12">
      <div className="mx-auto max-w-[980px] text-center mb-12">
        ...
        <p className="mt-2 text-muted-foreground">Todo lo que necesitás para gestionar tus canchas</p>
      </div>
