...
import { LayoutDashboard, CalendarCheck, Settings, Map, UsersRound, UserCog, LogOut } from 'lucide-react'
    ...
    <div className="min-h-screen bg-muted/10 flex flex-col lg:flex-row">
      ...
      <aside className="w-full lg:w-[260px] border-b lg:border-b-0 lg:border-r bg-card shadow-sm lg:min-h-screen lg:sticky lg:top-0 z-40 overflow-x-auto lg:overflow-x-hidden no-scrollbar">
        ...
        <nav className="flex lg:flex-col gap-1 text-sm font-medium p-3 lg:p-4 min-w-max lg:min-w-0">
          <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-muted text-foreground transition-colors" href="/admin">
            <LayoutDashboard className="h-4 w-4 text-muted-foreground" />
            <span>Dashboard</span>
          </Link>
          <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-muted text-foreground transition-colors" href="/admin/bookings">
          ...
          {isOwner && (
            <>
              ...
              <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-muted text-foreground transition-colors" href="/admin/venue/edit">
                <Settings className="h-4 w-4 text-muted-foreground" />
                <span>Configuración</span>
              </Link>
              <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-muted text-foreground transition-colors" href="/admin/courts">
                <Map className="h-4 w-4 text-muted-foreground" />
                <span>Canchas</span>
              </Link>
              <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-muted text-foreground transition-colors" href="/admin/members">
                <UsersRound className="h-4 w-4 text-muted-foreground" />
                <span>Socios</span>
              </Link>
              <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-muted text-foreground transition-colors" href="/admin/users">
          ...
          <div className="lg:hidden mx-2 w-px h-6 bg-border/50 self-center" />
          <Link className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-destructive/10 text-destructive transition-colors lg:mt-auto" href="/dashboard">
